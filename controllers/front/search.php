...
class BeesBlogsearchModuleFrontController extends BeesBlogModuleFrontController
{
    ...
    public function initContent()
    {
        ...
        $keyword = Tools::getValue('coolsearch');
        $idLang = (int) $this->context->language->id;
        $result = BeesBlogPost::coolBlogSearchPost($keyword, $idLang, $limitStart, $limit);

        $total = BeesBlogPost::coolBlogSearchPostCount($keyword, $idLang);
        ...
        $this->context->smarty->assign(array(
            ...
            'coolsearch' => Tools::getValue('coolsearch'),
