...
class AdminBeesBlogCategoryController extends \ModuleAdminController
{
    ...
    {
        $imageDescription = $this->l('Upload an avatar from your computer. N.B : Only jpeg images are allowed.');
        if (\Tools::getValue(BeesBlogCategory::PRIMARY)) {
            // FIXME: move to Smarty
            $imageDescription .= '<br/><img style="height:auto;width:300px;clear:both;border:1px solid black;" alt="" src="'.__PS_BASE_URI__.'modules/beesblog/images/category/'.\Tools::getValue(BeesBlogCategory::PRIMARY).'.jpg" /><br />';
        }
